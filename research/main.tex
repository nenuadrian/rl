...
\]
is an unbiased estimator of the weighted-MLE gradient under the dropout distribution, exactly as in supervised learning. This structural property generalises the later dropout discussion to a consequence of the GEMPI decomposition: methods instantiated within GEMPI inherit M-step dropout compatibility.
